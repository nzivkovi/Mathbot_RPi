...
##            self.obstacles.append(Body(obstacle[0], obstacle[1]))
    ...
    def calculate_distance_from_goal(self):
        ...
        self.distance_from_goal = (math.sqrt(math.pow(self.estimated_state.x - x_goal, 2) + math.pow(self.estimated_state.y - y_goal, 2)))/1.5
    ...
    def estimate_position(self):
        ...
        self.estimated_state.x = x + distance_center*math.cos(phi)*2
        self.estimated_state.y = y + distance_center*math.sin(phi)*1.5
        phi_new = phi + phi_dt*0.93
